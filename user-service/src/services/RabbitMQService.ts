...
class RabbitMQService {
    ...
    async init() {
        ...
        /**
         * @info -> Establish connection to RabbitMQ server
        */
        this.connection = await amqp.connect(config.msgBrokerURL!);
        this.channel = await this.connection.createChannel();

        /**
         * @info -> Asserting queues ensures they exist
        */
        await this.channel.assertQueue(this.requestQueue);
        await this.channel.assertQueue(this.responseQueue);

        /**
        * @info -> Start listening for messages on the request queue
        */
    ...
    private async listenForRequests() {
        this.channel.consume(this.requestQueue, async (msg) => {
            if (msg && msg.content) {
                ...
                /**
                  *@info -> Send the user details response
                */
                ...
                /**
                  *@info -> Acknowledge the processed message
                */
